      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden md:flex items-center space-x-4">
            ...
            <NavLink page={Page.DASHBOARD} currentPage={currentPage} setCurrentPage={setCurrentPage}>Dashboard</NavLink>
          </nav>
          <div className="flex items-center space-x-4">
             ...
             <button className="px-4 py-2 bg-teal-600 text-white rounded-lg hover:bg-teal-500 transition-colors duration-300 shadow-md">
                Login
             </button>
          </div>
        </div>
